...
def exs(name):
    ...
    ex1n_valid["log_path"] = "./log_syn_s2/ex1n/"
    ...
    ex2n_valid["log_path"] = "./log_syn_s2/ex2n/"
    ...
    ex2n["drp_cnv"] = 0.8
    ex2n["drp_pose"] = 0.8
    ex2n["restore_file"] = "plx64-100.meta"  # keep empty to not restore a model.
    ...
    ex3n_valid["log_path"] = "./log_syn_s2/ex3n/"
    ...
    ex4n["model"] = Model_8n
    ex4n["learning_rate"] = 0.001
    ex4n["num_iterations"] = 200
    ex4n["debug_output"] = True
    ex4n["log_path"] = "./log_syn_s2/ex4n/"
    ex4n["log_file"] = "plx64"
    ex4n["train"] = True
    ex4n["eval"] = False
    ex4n["test"] = False
    ...
    ex5n["drp_cnv"] = 0.95
    ex5n["drp_pose"] = 0.95
    ex5n["restore_file"] = "plx64-100.meta"  # keep empty to not restore a model.
    ex5n["quat_used"] = False  # set true, if the dataset contains quaternions. Otherwise false.
    ex5n["plot_title"] = "plx128_stage2: ex5n"
    ...
    ex6n_valid["learning_rate"] = 0.01
    ex6n_valid["num_iterations"] = 100
    ex6n_valid["debug_output"] = True
    ex6n_valid["log_path"] = "./log_syn_s2/ex6n/"
    ...
    ex6n_valid["plot_title"] = "plx128_stage2: ex6n"
    ...
    ex6n["model"] = Model_8n
    ex6n["learning_rate"] = 0.01
    ex6n["num_iterations"] = 100
    ex6n["debug_output"] = True
    ex6n["log_path"] = "./log_syn_s2/ex6n/"
    ex6n["log_file"] = "plx64"
    ex6n["train"] = True
    ex6n["eval"] = False
    ex6n["test"] = False
    ...
    ex6n["plot_title"] = "plx128_stage2: ex6n"
    ...
    ex7n_valid["learning_rate"] = 0.01
    ex7n_valid["num_iterations"] = 100
    ex7n_valid["debug_output"] = True
    ex7n_valid["log_path"] = "./log_syn_s2/ex7n/"
    ...
    ex7n["model"] = Model_8n
    ex7n["learning_rate"] = 0.01
    ex7n["num_iterations"] = 100
    ex7n["debug_output"] = True
    ex7n["log_path"] = "./log_syn_s2/ex7n/"
    ex7n["log_file"] = "plx64"
    ex7n["train"] = True
    ex7n["eval"] = False
    ex7n["test"] = False
    ...
    ex7n["drp_cnv"] = 0.95
    ex7n["drp_pose"] = 0.95
    ex7n["restore_file"] = "plx64-100.meta"  # keep empty to not restore a model.
