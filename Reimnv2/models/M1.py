...
class M1(keras.Model):
    ...
    def __init__(self, number_classes=2,img_height=128,chanDim=-1):
        ...
        self.conv5u = Conv2D(128,(1,1),padding="same",kernel_initializer='GlorotNormal')
        # Layer 6
        self.up_sam6 = UpSampling2D((2,2), interpolation="bilinear")
        self.conv6u = Conv2D(64,(1,1),padding="same",kernel_initializer='GlorotNormal')
        # Layer 7
        self.up_sam7 = UpSampling2D((2,2), interpolation="bilinear")
        self.conv7u = Conv2D(32,(1,1),padding="same",kernel_initializer='GlorotNormal')
        # Layer 8
        self.up_sam8 = UpSampling2D((2,2), interpolation="bilinear")
        self.conv8u = Conv2D(self.number_of_classes, (1, 1), padding="same",kernel_initializer='GlorotNormal')
