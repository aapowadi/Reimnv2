...
class SM44(keras.Model):
    ...
    def __init__(self, number_classes=2,img_height=128,chanDim=-1):
        ...
        self.conv5 = nconv_layer((3, 3), 256, 128, (1, 1), tf.keras.initializers.RandomNormal(stddev=0.01), wname="pw1")
        # Layer 6
        self.up_sam6 = upsample_layer(128,2,"deconv2")
        self.conv6 = nconv_layer((3, 3), 128, 64, (1, 1), tf.keras.initializers.RandomNormal(stddev=0.01), wname="pw2")
        # Layer 7
        self.up_sam7 = upsample_layer(64,2,"deconv3")
        self.conv7 = nconv_layer((3, 3), 64, 32, (1, 1), tf.keras.initializers.RandomNormal(stddev=0.01), wname="pw3")
        # Layer 8
        self.up_sam8 = upsample_layer(32,2,"deconv4")
        self.conv8 = nconv_layer((3, 3), 32, self.number_of_classes, (1, 1),
