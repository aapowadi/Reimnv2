...
def exs(name):
    ...
    ex_test_valid = {}
    ex_test_valid["train_dataset"] = "../../datasets/tr-probe-128.pickle"
    ex_test_valid["test_dataset"] = "../../datasets/tr-probe-128.pickle"
    ex_test_valid["solver"] = solver_nvalid
    ex_test_valid["model"] = Model_8n
    ex_test_valid["learning_rate"] = 0.001
    ...
    ex_test_valid["plot_title"] = "plx64_stage2: ex_test"
    ex_test_valid["label"] = "Experiment.py"
    if name == "ex_test_valid":
        name = ex_test_valid

    ex_test = {}
    ex_test["train_dataset"] = "../../datasets/tr-probe-128.pickle"
    ex_test["test_dataset"] = "../../datasets/tr-probe-128.pickle"
    ex_test["solver"] = Solver_nrm
    ...
    ex_test["plot_title"] = "plx64_stage2: ex_test"
