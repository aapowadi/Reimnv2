...
from solvers.Solver_nrm2 import *
...
def exs(name):
    ex1n_valid = {}
    ex1n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex1n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex1n_valid["log_path"] = "./log_real_overfit/ex1n/"
    ...
    ex1n = {}
    ex1n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex1n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex1n["solver"] = Solver_nrm
    ex1n["model"] = Model_8n
    ex1n["learning_rate"] = 0.1
    ex1n["num_iterations"] = 100
    ex1n["debug_output"] = True
    ex1n["log_path"] = "./log_real_overfit/ex1n/"
    ex1n["log_file"] = "plx64"
    ex1n["train"] = True
    ex1n["eval"] = False
    ex1n["test"] = False
    ...
    ex2n_valid = {}
    ex2n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex2n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex2n_valid["log_path"] = "./log_real_overfit/ex2n/"
    ...
    ex2n = {}
    ex2n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex2n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex2n["solver"] = Solver_nrm
    ex2n["model"] = Model_8n
    ex2n["learning_rate"] = 0.001
    ex2n["num_iterations"] = 100
    ex2n["debug_output"] = True
    ex2n["log_path"] = "./log_real_overfit/ex2n/"
    ex2n["log_file"] = "plx64"
    ex2n["train"] = True
    ex2n["eval"] = False
    ex2n["test"] = False
    ...
    ex3n_valid = {}
    ex3n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex3n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex3n_valid["solver"] = solver_nvalid
    ex3n_valid["model"] = Model_8n
    ex3n_valid["learning_rate"] = 0.01
    ex3n_valid["num_iterations"] = 100
    ex3n_valid["debug_output"] = True
    ex3n_valid["log_path"] = "./log_real_overfit/ex3n/"
    ...
    ex3n = {}
    ex3n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex3n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex3n["solver"] = Solver_nrm
    ex3n["model"] = Model_8n
    ex3n["learning_rate"] = 0.01
    ex3n["num_iterations"] = 100
    ex3n["debug_output"] = True
    ex3n["log_path"] = "./log_real_overfit/ex3n/"
    ex3n["log_file"] = "plx64"
    ex3n["train"] = True
    ex3n["eval"] = False
    ex3n["test"] = False
    ...
    ex4n_valid = {}
    ex4n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex4n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex4n_valid["log_path"] = "./log_real_overfit/ex4n/"
    ...
    ex4n = {}
    ex4n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex4n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex4n["solver"] = Solver_nrm
    ex4n["model"] = Model_8n
    ex4n["learning_rate"] = 0.004
    ex4n["num_iterations"] = 100
    ex4n["debug_output"] = True
    ex4n["log_path"] = "./log_real_overfit/ex4n/"
    ex4n["log_file"] = "plx64"
    ex4n["train"] = True
    ex4n["eval"] = False
    ex4n["test"] = False
    ...
    ex5n_valid = {}
    ex5n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex5n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex5n_valid["log_path"] = "./log_real_overfit/ex5n/"
    ...
    ex5n = {}
    ex5n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex5n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex5n["solver"] = Solver_nrm
    ex5n["model"] = Model_8n
    ex5n["learning_rate"] = 0.005
    ex5n["num_iterations"] = 100
    ex5n["debug_output"] = True
    ex5n["log_path"] = "./log_real_overfit/ex5n/"
    ex5n["log_file"] = "plx64"
    ex5n["train"] = True
    ex5n["eval"] = False
    ex5n["test"] = False
    ...
    ex6n_valid = {}
    ex6n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex6n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex6n_valid["log_path"] = "./log_real_overfit/ex6n/"
    ...
    ex6n = {}
    ex6n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex6n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex6n["solver"] = Solver_nrm
    ex6n["model"] = Model_8n
    ex6n["learning_rate"] = 0.006
    ex6n["num_iterations"] = 100
    ex6n["debug_output"] = True
    ex6n["log_path"] = "./log_real_overfit/ex6n/"
    ex6n["log_file"] = "plx64"
    ex6n["train"] = True
    ex6n["eval"] = False
    ex6n["test"] = False
    ...
    ex7n_valid = {}
    ex7n_valid["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex7n_valid["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ...
    ex7n_valid["log_path"] = "./log_real_overfit/ex7n/"
    ...
    ex7n = {}
    ex7n["train_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex7n["test_dataset"] = "../../datasets/cnn-gt-128.pickle"
    ex7n["solver"] = Solver_nrm
    ex7n["model"] = Model_8n
    ex7n["learning_rate"] = 0.007
    ex7n["num_iterations"] = 100
    ex7n["debug_output"] = True
    ex7n["log_path"] = "./log_real_overfit/ex7n/"
    ex7n["log_file"] = "plx64"
    ex7n["train"] = True
    ex7n["eval"] = False
    ex7n["test"] = False
