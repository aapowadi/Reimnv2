...
def eval_pose_accuracy(t_gt, t_pr, q_gt, q_pr, filepath = ""):
    ...
    # write a header
    file = open(filepath+"Valid_pose_acc.csv", "w")
    #file.write("pose rms,orient_rms\n")
    file.close()
    file1 = open(filepath + "Valid_pose_prec_rec.csv", "w")
    #file1.write("pose_prec_rec,orient_prec_rec\n")
    file1.close()
    ...
    file = open(filepath + "Valid_pose_acc.csv", "a")
