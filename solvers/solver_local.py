    ...
    def __start_train(self):
        ...
        with tf.Session() as sess:
            ...
            for i in range(self.num_epochs):
                ...
                print("Epoch {self.step}, loss {test_loss / 4096}, avg. precison: {precision}, avg. recall: {recall}, pose t loss: {test_pose_t_loss}, pose q loss: {test_pose_q_loss}")
    ...
    def __start_eval(self, Xte_rgb, Xte_depth, Yte_mask, Yte_pose):
        ...
        with tf.Session() as sess:
            ...
            for start, end in validation_batch:
                ...
                print("Batch {i}, seg. loss {loss / 4096}, seg. precison: {precision}, seg. recall: {recall}, pose t loss: {t_loss}, pose q loss: {q_loss}")
