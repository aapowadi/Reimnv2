...
#SBATCH --job-name="128synof"
#SBATCH --output="s%j.out" # job standard output file (%j replaced by job id)
#
. ../../cnn/bin/activate
cd /home/aapowadi/anirudha/m_exps/over_fit_128/
python ex_syn_of.py -i ex1n

python ex_syn_of.py -i ex1n_valid

python ex_syn_of.py -i ex2n

python ex_syn_of.py -i ex2n_valid

python ex_syn_of.py -i ex3n

python ex_syn_of.py -i ex3n_valid
#
