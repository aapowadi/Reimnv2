...
#python ex_real.py -i ex8n

python ex_real.py -i ex8n_valid

#python ex_real.py -i ex9n
#
#python ex_real.py -i ex9n_valid

#python ex_real.py -i ex10n

python ex_real.py -i ex10n_valid
#
#python ex_real.py -i ex11n
#
#python ex_real.py -i ex11n_valid